...
{
    public class HorarioExtraController : Controller
    {
        private readonly IHorarioExtraRepository _horarioRepository;
        private readonly ICampoItemRepository _campoItemRepository;
        private readonly IFlashMessage _flashMessage;


        public HorarioExtraController(IHorarioExtraRepository horarioRepository, IFlashMessage flashMessage, ICampoItemRepository campoItemRepository)
        {
        ...
        public IActionResult Create([Bind("IDITEMCAMPO,DATA,HORARIO")] HorarioExtra _horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("ID,IDITEMCAMPO,DATA,HORARIO")] HorarioExtra _horario)
        {
            if (id != _horario.ID)
                return NotFound();
